...
function initP2PTrade_init_args(src: P2PTrade_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        ...
        b_1.storeAddress(src.arbitrator);
        b_1.storeInt(src.amount, 257);
        b_0.storeRef(b_1.endCell());
    };
}

async function P2PTrade_init(id: bigint, seller: Address, buyer: Address, arbitrator: Address, amount: bigint) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initP2PTrade_init_args({ $$type: 'P2PTrade_init_args', id, seller, buyer, arbitrator, amount })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const P2PTrade_errors = {
...
export const P2PTrade_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const P2PTrade_getters: ABIGetter[] = [
    {"name":"tradeData","methodId":119035,"arguments":[],"returnType":{"kind":"simple","type":"address","optional":false}},
]

export const P2PTrade_getterMapping: { [key: string]: string } = {
    'tradeData': 'getTradeData',
}

const P2PTrade_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"SetPaid"}},
    {"receiver":"internal","message":{"kind":"typed","type":"ConfirmRelease"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Dispute"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Arbitrate"}},
    {"receiver":"internal","message":{"kind":"empty"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]


export class P2PTrade implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = P2PTrade_errors_backward;
    public static readonly opcodes = P2PTrade_opcodes;
    
    static async init(id: bigint, seller: Address, buyer: Address, arbitrator: Address, amount: bigint) {
        return await P2PTrade_init(id, seller, buyer, arbitrator, amount);
    }
    
    static async fromInit(id: bigint, seller: Address, buyer: Address, arbitrator: Address, amount: bigint) {
        const __gen_init = await P2PTrade_init(id, seller, buyer, arbitrator, amount);
        const address = contractAddress(0, __gen_init);
        return new P2PTrade(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new P2PTrade(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  P2PTrade_types,
        getters: P2PTrade_getters,
        receivers: P2PTrade_receivers,
        errors: P2PTrade_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: SetPaid | ConfirmRelease | Dispute | Arbitrate | null | Deploy) {
        
        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'SetPaid') {
            body = beginCell().store(storeSetPaid(message)).endCell();
        }
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'Arbitrate') {
            body = beginCell().store(storeArbitrate(message)).endCell();
        }
        if (message === null) {
            body = new Cell();
        }
    ...
    async getTradeData(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('tradeData', builder.build())).stack;
